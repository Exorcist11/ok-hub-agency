...
export default function Contact() {
  return (
    <div className="fixed bottom-14 flex flex-col gap-5 right-10 z-50 ">
      <div>
        <div className="bg-[#E64827] p-3 rounded-full w-fit text-white  cursor-pointer text-[10px] text-center">
          <p>BOOK</p>
          <p>NOW</p>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center">
        ...
        >
          ...
          <path
            ...
            fill="white"
          />
          <g filter="url(#filter0_d_183_1681)">
            <circle cx="42" cy="16" r="6" fill="#17E268" />
          </g>
          <defs>
            <filter
              id="filter0_d_183_1681"
              x="26"
              y="0"
              width="32"
              height="32"
            ...
            >
              ...
              <feBlend
                ...
                result="effect1_dropShadow_183_1681"
              />
              <feBlend
                mode="normal"
                in="SourceGraphic"
                in2="effect1_dropShadow_183_1681"
                result="shape"
              />
            </filter>
          </defs>
      ...
      <div>
        <div className="border-4 border-[#E64827] p-3 rounded-full w-fit text-white  cursor-pointer text-[10px] text-center">
          <IoIosArrowUp size={20} color="#E64827" fontWeight={800} />
        </div>
      </div>
    </div>
  );
